...
temaComun: 
          COMEN {printf("--------------------------ESTO ES UN COMENTARIO\n\n\n");}
...
temaEspecial: 
            ifUnario {printf("--------------------------ESTO ES UN IF UNARIO\n\n\n");}
...
salida: 
      DISPLAY {printf("ok display\n");}
      terminoSalida {printf("ok terminoDisplay\n");}
      ;

terminoSalida: 
            CONST_STR     {printf("ok const_string\n");}
